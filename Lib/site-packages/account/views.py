...
class SignupView(FormView):
    ...
    def create_user(self, form, commit=True, **kwargs):
        ...
        #date_of_birth_year = form.cleaned_data["date_of_birth_year"].strip()
        #date_of_birth_month = form.cleaned_data["date_of_birth_month"].strip()
        #date_of_birth_day = form.cleaned_data["date_of_birth_day"].strip()
        #user.date_of_birth = "{0}-{1}-{2}".format(date_of_birth_year,date_of_birth_month,date_of_birth_day)
