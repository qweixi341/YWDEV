...
class MyUserAdmin(UserAdmin):
    ...
    list_display = ('username', 'first_name', 'last_name', 'email', 'date_of_birth', 'is_admin', 'created_date' ,'modified_date')
    list_filter = ('is_admin',)
    fieldsets = (
        (None, {'fields': ('username', 'password')}),
        ('Personal info', {'fields': ('username', 'first_name', 'last_name', 'email', 'date_of_birth',)}),
